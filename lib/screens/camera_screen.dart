...
class _CameraScreenState extends State<CameraScreen> {
          ...
          if (rightSide.isEmpty) {
            ...
            try {
              ...
              if (widget.isPracticeMode) {
                ...
                String targetLeftSide =
                    expectedEq.split('=')[0].replaceAll(' ', '');
                ...
                if (detectedLeftSide != targetLeftSide) {
                  ...
                  _flutterTts.speak(
                      "Oops! Please build $displayTargetLeft equals question mark.");
  ...
  void _handleIncorrectAnswer(
    ...
    String actualCorrectEq =
        expectedEquation ?? "$num1 $op $num2 = $calculatedResult";
    ...
    if (consecutiveMistakes == 1) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text("Not quite! Try one more time.",
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => DigitalCapsScreen(
